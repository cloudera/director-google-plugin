...
public class GoogleCloudSQLInstance
  ...
  private static final List<DisplayProperty> DISPLAY_PROPERTIES =
      DisplayPropertiesUtil.asDisplayPropertyList(GoogleCloudSQLInstanceDisplayPropertyToken.values());
   ...
   */
  public enum GoogleCloudSQLInstanceDisplayPropertyToken implements DisplayPropertyToken {
     ...
     */
    GoogleCloudSQLInstanceDisplayPropertyToken(DisplayProperty displayProperty) {
  ...
  public Map<String, String> getProperties() {
    ...
    if (instance != null) {
      for (GoogleCloudSQLInstanceDisplayPropertyToken propertyToken : GoogleCloudSQLInstanceDisplayPropertyToken.values()) {
