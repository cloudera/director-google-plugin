...
public class GoogleComputeProvider
  ...
  public void allocate(GoogleComputeInstanceTemplate template,
    ...
    // Use this list to collect the operations that must reach a pending state prior to allocate() returning.
    ...
    for (String instanceId : instanceIds) {
      ...
      // Use this list to collect the operations that must complete prior to provisioning the instance.
